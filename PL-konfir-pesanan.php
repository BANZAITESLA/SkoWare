    ...
    <?php
        ...
        if ($db->connect_errno == 0) {
            if(isset($_POST['query'])) { /* ketika ada input cari */
                ...
                $sql = "SELECT detail_pesanan.id_menu, nama_menu, harga_item, qty, sub_total FROM detail_pesanan, menu_minuman WHERE detail_pesanan.id_menu = menu_minuman.id_menu AND detail_pesanan.id_pesanan = '$cari'";
                $res = $db->query($sql);
                if ($res) {
