    ...
    ?>
        <div class="sidebar"> <!-- bagian sidebar -->
                ...
                <div class="button"> <!-- isi button -->
                    <a href="pengaturan_mejadankursi.php">Pengaturan Meja dan Kursi</a>
                    <a href="kodingan_waiting_list.php">Waiting List</a>
                    <a href="pengantaranpesanan.php">Pengantaran Pesanan</a>
                </div>
